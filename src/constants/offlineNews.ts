...
const offlineNews: IArticle[] = [
  ...
  },
  {
    ...
    video_url: null,
    description:
      'Kevin Feige, the president of Marvel Studios, has given a Blade update for the Phase 5 Mahershala Ali-led superhero movie-page. While talking with EW, Feige was asked about how Blade was coming along after facing difficulties late last year. As it turns out, the movie-page is set to start filming rather soon. “It’s going well,” […] The post Blade MCU Update: Kevin Feige Reveals When Movie Will Begin Filming appeared first on ComingSoon.net - Movie Trailers, TV & Streaming News, and More.',
    content:
      'Kevin Feige, the president of Marvel Studios, has given a Blade update for the Phase 5 Mahershala Ali-led superhero movie-page. While talking with EW, Feige was asked about how Blade was coming along after facing difficulties late last year. As it turns out, the movie-page is set to start filming rather soon. “It’s going well,” Feige declared. “Our director Yann [Demange] is down in Atlanta right now. Cameras roll in, like, the next 10 weeks or so.” Blade‘s production had a turbulent period late last year, with director Bassim Tariq leaving the project in September. Originally set to release on November 3, 2023, the movie-page ended up delayed to September 6, 2024. Yann Demange is now set to direct Blade from a script by Michael Starrbury. The film is set to be part of Phase Five of the Marvel Cinematic Universe, which will also contain Captain America: New World Order and Daredevil: Born Again. The Blade trilogy from New Line Cinema helped shepherd comic books and superheroes to the big screen. Combined, the three films brought in over $400 million at the global box office. Blade was created by writer Marv Wolfman and artist Gene Colan as a supporting character in the comic book The Tomb of Dracula #10 in July 1973. The post Blade MCU Update: Kevin Feige Reveals When Movie Will Begin Filming appeared first on ComingSoon.net - Movie Trailers, TV & Streaming News, and More.',
  ...
  },
  {
    ...
    image_url:
      'https://i2-prod.manchestereveningnews.co.uk/incoming/article25885188.ece/ALTERNATES/s615/0_pcl3060_mp01_v001_wr_g_r709_1050_089626_0.jpg',
  ...
  },
  {
    ...
    content:
      "The third film in Marvel's Ant-Man trilogy sends the MCU's tinest titans into a subatomic universe, where they — and we the viewers — get stuck.(Image credit: Marvel Studios)",
  ...
  },
  {
    ...
    video_url: null,
    description:
      "Next James Bond bookies' favourite Aaron Taylor-Johnson has reportedly had a screen test to be Daniel Craig's replacement and now he's finally addressed those huge 007 rumours.",
    content:
