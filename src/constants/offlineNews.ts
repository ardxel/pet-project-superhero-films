...
const offlineNews: IArticle[] = [
  {
    "title": "Ant-Man And The Wasp: Quantumania – Movie Review",
    "link": "https://insidexpress.com/entertainment/movies/ant-man-and-the-wasp-quantumania-movie-review-2/?utm_source=rss&utm_medium=rss&utm_campaign=ant-man-and-the-wasp-quantumania-movie-review-2",
    "keywords": [
      "Movies",
      "AntMan",
      "Movie",
    ...
    "video_url": null,
    "description": "Marvel movies tend to live or die on their villains. Remember Thanos? Of course you do, his menacing, purple mug made Avengers: Endgame unmissable. But what about Iron Man 2‘s…",
    "content": "M arvel movies tend to live or die on their villains. Remember Thanos? Of course you do, his menacing, purple mug made Avengers: Endgame unmissable. But what about Iron Man 2‘s Ivan Vanko? No, us neither. Yon-Rogg in Captain Marvel? Utterly forgettable. The point is, if you’re making a comic book blockbuster and you want to take on James Cameron at the box office, get a good baddie. In Jonathan Majors’ muscly brute Kang, Ant-Man And The Wasp: Quantumania has one of the best. This third adventure for Paul Rudd’s diminutive superhero takes us into the weird and wacky world of the Quantum Realm. Sucked inside when a science experiment goes wrong, Scott Lang (aka the incredible shrinking Ant-Man) and his daughter Cassie (Kathryn Newton), get separated from the rest of their family. That’s Scott’s partner Hope Van Dyne aka The Wasp (Evangeline Lilly) and her physics genius parents Janet (Michelle Pfeiffer) and Hank Pym (Michael Douglas). Luckily, Janet’s been here before – she once spent 30 years trapped in the QR before escaping – and tells the others about any dangerous traps or alien mercenaries to avoid. What she doesn’t tell them is that Kang, a mysterious, all-powerful being bent on destroying the universe, is her nemesis. And now she’s returned to his kingdom, which he rules with a leather-gloved iron fist, he’s hellbent on revenge. Kang The Conqueror, Marvel’s new villain. CREDIT: Marvel Studios/Disney To say any more would spoil the film, but rest assured event.current is top-drawer MCU. Previous Ant-Man films felt slight compared to their bigger Avengers brothers, and even director Peyton Reed concedes the action-comedies were only “fun little palate cleansers”. Quantumania is different. Much darker in tone and more impactful to the franchise’s overarching narrative, Lang’s psychedelic sojourn has a weightier feel to it that’s more in keeping with the Russo Brothers’ climactic epics Infinity War and Endgame. For starters, there’s a lot more stuff. Home to a strange array of quirky “quantum people” – martians made out of broccoli, Bill Murray’s creepy space-lord, a warrior who shoots lasers out of his face made of stars – the new intergalactic location seems to have very few actual rules. Can’t understand the regional dialect? Here, drink event.current gloopy extraterrestrial’s blood and instantly become a polyglot. Don’t know how to fly a rocket ship? Plug your arms into the controls and pilot by brainpower. There’s more than a whiff of Star Wars about the place (hey there, cantina), but with enough reinvention to make it all fresh and very, very fun. Paul Rudd, Kathryn Newton and Evangeline Lilly team up in ‘Quantumania’. CREDIT: Marvel Studios/Disney And then there’s Kang. Blessed with the ability to bend the cosmos to his will (“time is not what you think it is”), Majors’ cool yet commanding tyrant dominates every scene he’s in. Whether it’s quelling dissent with a single stare or flipping a finger to dispatch his enemies, Kang has an intimidating presence not unlike Darth Vader. In fact, he’s so compelling that after his initial introduction about half-way through Quantumania, the other characters seem less interesting by comparison. Rudd and Lilly might be first-billed on the poster, but event.current is undeniably the Majors show – did Marvel just find its next great villain? Details Director: Peyton Reed Starring: Paul Rudd, Evangeline Lilly, Jonathan Majors Release date: February 17 (in cinemas) Publisher",
    "pubDate": "2023-02-16 05:03:52",
    "image_url": "plug",
  ...
  },
  {
    ...
    "creator": null,
    "video_url": null,
    "description": "NBC viewers will have to wait a while longer for another One Chicago crossover as bosses backpedalled on their previous announcement.",
    "content": "Chicago Fire: NBC teases 'A Guy I Used to Know' episode SUBSCRIBE Invalid email We use your sign-up to provide content in ways you've consented to and to improve our understanding of you. This may include adverts from us and 3rd parties based on our understanding. You can unsubscribe at any time. More info The last time fans saw their favourite characters from NBC’s Chicago franchise share a screen was during the 2019 crossover. Although a new three-way episode surrounding Violet Mikami (played by Hanako Greensmith) was teased, bosses have since dropped a disappointing update. Related articles Denise Welch sparks uproar with Nicola Bulley comments Doctor Who exclusive first-look as Ncuti Gatwa pictured on set One Chicago has become a highly anticipated annual event for fans as Chicago Fire, Chicago PD and Chicago Med come together for three gripping hours on NBC. However, since the pandemic and social distancing rules, One Chicago has yet to deliver another crossover. Sadly for fans, they could be forced to wait even longer for the special despite bosses dropping a major tease last year. In September 2022, showrunner Andrea Newman revealed: “ It’s a possibility.” READ MORE: BBC cancels two major shows in blow to Paddy McGuinness Chicago Fire bosses share disappointing update about crossover (Image: NBC) Chicago Fire: the crossover was said to revolve around Violet (Image: NBC) READ MORE Endeavour's Shaun Evans lands new role as Morse series comes to an end Speaking to TVLine, she added: “There’ll be some fun stuff not only with our show, but in the #OneChicago universe with Violet’s family event.current year.” However, things have since changed as Andrea was recently quizzed about the potential crossover. The showrunner responded: “Right now there are no plans to do a family-related story for Violet with a connection to Med. “But we love when we have characters that can cross over to both shows, so who knows what will happen in the future,” she added to the publication. Chicago Fire: the last time there was a franchise crossover was in 2019 (Image: NBC) Chicago Fire: Hawkins was killed on duty (Image: NBC) As little is known about Violet’s family, viewers were looking forward to finding out more about her life away from Firehouse 51. The paramedic recently suffered major heartbreak following the death of her boyfriend and colleague Chief Evan Hawkins (Jimmy Nicholas). He was killed in the line of duty as he tried to save those who were trapped during a fire at a movie theatre. In a dramatic twist of fate, the building completely caved in on him as Violet was present and working elsewhere on the scene. DON'T MISS... Antiques Roadshow guest refuses to sell iconic Dad's Army item [INSIGHT] Chicago Fire star lands Netflix role opposite Marvel hero [INSIGHT] Chicago Fire's Carver set for romance after showrunner drops teaser [INSIGHT] Related articles Chicago Fire fans ‘heartbroken’ as Cindy Herrmann shares diagnosis Chicago Fire fans support Taylor Kinney as he takes 'leave of absence' Although fans were concerned the loss could also become Violet’s exit storyline, bosses confirmed she would grieve and eventually find peace. As Andrea told TVLine: “It’s not that she’s going to put the grief behind her altogether, but I think she definitely is moving into a lighter space and able to have a little more fun while also not forgetting Evan. He’s still a part of her life.” The last time viewers saw a crossover involving all three shows was in 2019 just before the pandemic swept the world. Titled, Infection, the crews from Chicago Fire, Chicago PD, and Chicago Med needed to deal with a city-wide rare and deadly outbreak created by a disgruntled scientist. Trending READ MORE Chicago Fire fans fear affair twist as concern grows over Stella Part one kicked off with Chicago Fire’s Matthew Casey (Jesse Spencer) noticing a man repeating the acronym “BRT” over and over again. After seeing his leg was covered in a gruesome flesh-eating bacteria, the infected man was rushed over to Chicago Med. Chicago Fire’s Firehouse 51 are eventually called into action to deal with a fire at a university which tied in with the outbreak. However, it was only after the paramedics forced entry into a house did they discover two dead bodies with the same symptoms as the infected man who was rushed to the hospital. Chicago Fire season 11 continues Wednesdays on NBC in the USA and the following Friday on Sky Witness in the UK. Related articles Chicago Fire delayed: Season 10 set for lengthy hiatus Chicago Fire season 10 delayed: NBC drama set for lengthy hiatus Chicago Fire bosses defend controversial character return Chicago Med casts NCIS Hawaii breakout in huge shake-up 'Gets rid of dandruff!' This £6 shampoo is a 'miracle' for dry scalps",
    "pubDate": "2023-02-16 02:30:00",
    "image_url": "plug",
  ...
  },
  {
    ...
    "video_url": null,
    "description": "It would probably be an understatement to note that Jonathan Majors is having a moment; better, probably, to say that he’s having the moment—the point where a well-respected young actor with a couple of break-out performances under his belt (Lovecraft Country, The Last Black Man In San Francisco) ascends into the…Read more...",
    "content": "It would probably be an understatement to note that Jonathan Majors is having a moment; better, probably, to say that he’s having moment—the point where a well-respected young actor with a couple of break-out performances under his belt ( , ) ascends into the Hollywood firmament. And while Majors actually has a of big performances on the way (including the upcoming and well- received festival feature ), the obvious sign of his ascension is his role as Marvel’s new marquee bad guy in event.current week’s —a part that almost didn’t happen, after Majors walked out of his very first meeting with Marvel several years ago. This is per a new interview the actor , in which he revealed that he actually initially walked out of his first meeting with the company when he was fresh out of drama school. I hope event.current doesn’t bite me in the ass, but I walked out of my Marvel general [meeting]. This was a long time ago. I had just gotten out of drama school and I’m running around town and I’m sitting in the office. I grew up in a very particular way and I don’t want to waste nobody’s time. So I got in there and they’re just busy. And I was like, “I’m supposed to be here, right?” It got long and I went, “ I’m just going to go. It’s cool. I’ll just go. ” And I got to the door, but then they said [casting director] Sarah Finn was going to come. We got in the room and we chatted. We were having event.current great conversation. I think it was three years later that we had the Kang chat. Now, though, Majors says he has no reservations about his role in the Marvel machine (which expected to extend through several films, as Kang becomes a primary antagonist for the studio’s upcoming movies), saying that, “There’s no trepidation now, especially because of who Kang is. When I said yes, we got the whole picture, and what is being laid out is cohesive.” That being said, he did note some ongoing discomfort with the ways his sudden stardom may end up impacting his life (and heaped some praise on co-star Michael B. Jordan in the process ) : “I don’t bother nobody. I’m not interested in the fuckery of the industry… Michael is such a good example of a movie star because movie stars have to appeal to the bourgeois and the proletariat. Movie stars can show a film in Montana. Movie stars are dangerous to politicians. It’s a different type of burden.”",
    "pubDate": "2023-02-15 23:38:00",
    "image_url": "plug",
    "source_id": "avclub",
    "category": [
      "entertainment"
  ...
  },
  {
    ...
    "video_url": null,
    "description": "Marvel Studios president Kevin Feige has shed a bit of light on the future of the Marvel Cinematic Universe, specifically stating that Marvel knows when and how they’ll introduce the iconic X-Men. In an interview with EW, Feige was asked about how mutants will play into the future of the MCU, as both Ms. Marvel‘s […] The post Marvel Now Knows When & How to Introduce the X-Men into the MCU appeared first on ComingSoon.net - Movie Trailers, TV & Streaming News, and More.",
    "content": "Marvel Studios president Kevin Feige has shed a bit of light on the future of the Marvel Cinematic Universe, specifically stating that Marvel knows when and how they’ll introduce the iconic X-Men. In an interview with EW, Feige was asked about how mutants will play into the future of the MCU, as both Ms. Marvel‘s Kamala Khan and Black Panther: Wakanda Forever‘s Namor were referred to as mutants. Feige clarified that mutant is a real genetic term, but that Marvel does indeed know how they’ll be introducing one of Marvel’s most famous teams. “You know, I think we’ve said the word once. Kamala talks about a genetic mutation, and Namor refers to himself as a mutant amongst his own people,” Feige clarified. “And mutant is a real genetic term, not just a comic book term. “But part of the fun is that I’ve been at event.current company for half my life, and we’re just now tapping into arguably one of the biggest aspects of the publishing history. It’s pretty remarkable, and it’s a testament to the house of ideas and what Marvel publishing has done these 80 years. The question is how to do it and when to do it, and that’s something we’ve been working on for years. Now we know. But we’re not going to talk about it.” Mutants in the Marvel universe are people who possess the X-gene — a genetic trait that manifests during puberty as superpowers. The Disney+ Ms. Marvel series ended with the main character Kamala Khan being revealed to be a mutant — a moment which was accompanied by a short segment of the 90s X-Men animated series theme song. Mutants play a major role in the world of Marvel’s comics, so fans are eager to see their full introduction to the MCU. The post Marvel Now Knows When & How to Introduce the X-Men into the MCU appeared first on ComingSoon.net - Movie Trailers, TV & Streaming News, and More.",
    "pubDate": "2023-02-15 19:40:00",
    "image_url": "plug",
    "source_id": "comingsoon",
    "category": [
      "entertainment"
  ...
  },
  {
    ...
    "video_url": null,
    "description": "The third film in Marvel's Ant-Man trilogy sends the MCU's tinest titans into a subatomic universe, where they — and we the viewers — get stuck.",
    "content": "The third film in Marvel's Ant-Man trilogy sends the MCU's tinest titans into a subatomic universe, where they — and we the viewers — get stuck.(Image credit: Marvel Studios)",
    "pubDate": "2023-02-15 17:03:00",
    "image_url": "plug",
    "source_id": "npr",
    "category": [
      "entertainment"
  ...
  {
    "title": "Ant-Man and the Wasp: Quantumania movie review: ignore the convoluted plot and you’ll have a blast",
  ...
  },
  {
    ...
    "creator": null,
    "video_url": null,
    "description": "Next James Bond bookies' favourite Aaron Taylor-Johnson has reportedly had a screen test to be Daniel Craig's replacement and now he's finally addressed those huge 007 rumours.",
    "content": "Aaron Taylor-Johnson wins Best Performance Golden Globe in 2017 SUBSCRIBE Invalid email We use your sign-up to provide content in ways you've consented to and to improve our understanding of you. This may include adverts from us and 3rd parties based on our understanding. You can unsubscribe at any time. More info Speculation over who the next James Bond will be has been rife over the last few years since Daniel Craig exited the 007 franchise so explosively in No Time To Die. It’s been almost 20 years since the last round of Bond auditions and according to reports they’ve already been happening in secret with Kick-Ass and Avengers: Age of Ulton star Aaron Taylor-Johnson being the frontrunner. Related articles Next James Bond announcement – Unveiling of new 007 rumoured very soon Maud Adams injured Roger Moore's 'sensitive region' on James Bond set The 32-year-old is certainly the right age to be starting a career as Bond and has a ton of experience in action cinema, most recently co-starring in Bullet Train with Brad Pitt. Taylor-Johnson is also on the cusp of being an A-lister, having only previously starred in smaller movies and supported big ones. Although with Kraven the Hunter out later event.current year, that’s all about to change, so now is the perfect time for him to be cast as the new 007. And according to insiders, he’s certainly headed that way. Next James Bond favourite Aaron Taylor-Johnson 'who's auditioned' speaks out on 007 (Image: GETTY/MGM) The six official James Bond actors (Image: MGM) READ MORE Pierce Brosnan's 7 years delayed box office bomb gets 3 Razzie nods According to The Sun, sources previously said: “Aaron went for a screen test to be the next Bond in September and producers and Barbara [Broccoli] loved him. He is now one of the front-runners… Aaron has impressed bosses so much that he has filmed one of the franchise’s famous gun barrel teaser scenes, something all the Bond actors do. That move takes him a step closer to signing a deal. Bosses at the brand were really impressed with his unique blend of acting intensity and his impressive back catalogue of action films.” Rumour has it that Taylor-Johnson will be announced as the new Bond as soon as March. And now for the first time since all event.current 007 buzz began swirling around him, the actor himself has spoken out and it’s all sounding very positive. READ MORE: Sean Connery's James Bond co-star shot himself before 007 film wrapped Aaron Taylor-Johnson (Image: GETTY) Speaking with Vanity Fair, Taylor-Johnson said: “It’s flattering. You can have something really positive [written about you], but you can also have something really negative that can circulate. You just want to stay in your lane, stay grounded, stay around the people that you love and love you back, and stay in that world. Because the moment you start believing the s*** people say about you, you’ve lost your f***ing mind. You’ve lost it.” That certainly wasn’t a denial of the audition or shut down of the rumours like other bookies' favourites, was it? Check out the latest odds for next Bond below. DON'T MISS Most handsome James Bond star determined by Ancient Greek Golden Ratio [JAMES BONDS] Next James Bond favourite Aaron Taylor-Johnson ruled out by 007 star [AARON TAYLOR-JOHNSON] James Bond – James Brolin was devastated to be dropped as 007 [EXCLUSIVE] Trending Daniel Craig and producers at his James Bond announcement in 2005 (Image: GETTY) Taylor-Johnson leads the next Bond odds on 5-2 alongside Henry Cavill, who was Craig’s runner-up in the Casino Royale auditions 18 years ago. Just behind them are James Norton on 7-2, Regé-Jean Page on 6-1, Tom Hardy on 7-1 and Jack Lowden on 10-1. Fingers crossed an announcement is only a few weeks away as those rumours suggest. SOURCE Related articles Next James Bond – The major Marvel star backed by Adele James Bond – The amazing Die Another Day Easter Egg in No Time To Die Spectre in Concert – James Bond premiere thrills at Royal Albert Hall Roger Moore relied on booze and Valium on Bond set sabotaged by monks James Bond – Real reason Sean Connery's Skyfall cameo was shut down",
    "pubDate": "2023-02-15 14:52:43",
    "image_url": "plug",
    "source_id": "expresscouk",
    "category": [
      "entertainment"
