...
const MOCK_PATH = '<rootDir>/index/__mock__';
...
module.exports = {
  ...
  collectCoverageFrom: ['**/*.{ts,tsx,scss,css}', '!**/node_modules/**', '!**/vendor/**'],
  moduleNameMapper: {
  ...
  setupFilesAfterEnv: ['<rootDir>/src/tests/mockSetup.ts', '@testing-library/jest-dom'],
};
